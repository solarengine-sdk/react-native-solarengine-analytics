...
export function decorateEventType(obj: any): object {
  if (
    'adNetworkPlatform' in obj &&
    'adType' in obj &&
    'adNetworkAppID' in obj &&
    'adNetworkPlacementID' in obj &&
    'mediationPlatform' in obj &&
    'currency' in obj &&
    'ecpm' in obj &&
    'rendered' in obj &&
    'customProperties' in obj
  ) {
    ...
    'subChannel' in obj &&
    'adAccountID' in obj &&
    'adAccountName' in obj &&
    'adCampaignID' in obj &&
    'adCampaignName' in obj &&
    'adOfferID' in obj &&
    'adOfferName' in obj &&
    'adCreativeID' in obj &&
    'adCreativeName' in obj &&
    'attributionPlatform' in obj &&
    'customProperties' in obj
  ) {
    ...
    'eventName' in obj &&
    'customProperties' in obj &&
    ('preProperties' in obj || undefined === 'preProperties')
  ) {
